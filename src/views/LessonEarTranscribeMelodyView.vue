...
const items = [
  ...
  },
  {
    ...
    answer: 'a',
    options: [
      { label: 'до–соль–ми–до', value: 'a' },
      { label: 'до–ля–ми–до', value: 'b' },
      { label: 'до–соль–фа–до', value: 'c' },
    ],
  },
  {
    notes: ['D4', 'F4', 'A4', 'G4', 'D4'],
    answer: 'a',
    options: [
      { label: 'ре–фа–ля–соль–ре', value: 'a' },
      { label: 'ре–фа–си–соль–ре', value: 'b' },
      { label: 'ре–ми–ля–соль–ре', value: 'c' },
    ],
  },
]
...
<template>
  <div class="p-8">
    ...
    <div v-else>
      <h2 class="text-2xl font-semibold mb-2">Урок 121: Снятие короткой мелодии на слух</h2>
      <p class="text-textDim mb-6">Полноценная транскрипция: услышать мелодию и выбрать точную запись нот среди похожих вариантов.</p>
      ...
      <div class="border-t border-surface2 pt-8">
        ...
        <p class="text-sm text-textDim">
          Определи сначала первую ноту, затем каждый следующий шаг — интервалом от предыдущей ноты, а не заново от тоники. Именно так снимают мелодии
          на слух профессионалы: не абсолютным слухом, а цепочкой относительных шагов.
        </p>
      </div>
    </div>
  </div>
