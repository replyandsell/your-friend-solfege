...
const items = [
  { label: 'Мажор', notes: ['C4', 'E4', 'G4'], answer: 'major' },
  { label: 'Минор', notes: ['C4', 'Eb4', 'G4'], answer: 'minor' },
  { label: 'Мажор', notes: ['F4', 'A4', 'C5'], answer: 'major' },
  { label: 'Минор', notes: ['D4', 'F4', 'A4'], answer: 'minor' },
  { label: 'Мажор', notes: ['G4', 'B4', 'D5'], answer: 'major' },
  { label: 'Минор', notes: ['E4', 'G4', 'B4'], answer: 'minor' },
]
const options = [
...
<template>
  <div class="p-8">
    ...
    <div v-else>
      <h2 class="text-2xl font-semibold mb-2">Урок 114: Определение мажора и минора</h2>
      <p class="text-textDim mb-6">Мажор и минор — базовая развилка на слух. Тренируй мгновенное узнавание, не задумываясь над структурой аккорда.</p>
      ...
      <div class="border border-surface2 rounded-lg p-6 bg-surface mb-6">
        ...
        <template v-else>
          ...
          <p v-if="quiz.answered.value" class="mt-3 text-sm" :class="quiz.isCorrect.value ? 'text-green-600' : 'text-red-600'">
            {{ quiz.isCorrect.value ? 'Верно!' : `Неверно. Это был ${quiz.current.value.answer === 'major' ? 'мажор' : 'минор'}.` }}
          </p>
      ...
      <div class="border-t border-surface2 pt-8">
        ...
        <p class="text-sm text-textDim">
          Мажор звучит «светлее», минор — «темнее»: разница всего в один полутон терции, но слух улавливает её почти мгновенно после тренировки.
          Проходи квиз много раз подряд, пока угадывание не станет автоматическим.
        </p>
      </div>
    </div>
  </div>
