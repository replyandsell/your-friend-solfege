...
<template>
  <div class="mx-auto max-w-5xl p-8">
    <div class="rounded-3xl border border-surface2 bg-surface p-8 shadow-soft">
      <div class="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p class="mb-3 text-sm uppercase tracking-[0.2em] text-accent">Онлайн-курс</p>
          <h2 class="mb-3 text-3xl font-semibold">Наш друг - СОЛЬФЕДЖИО</h2>
          <p class="max-w-2xl text-textDim">
        ...
        <div class="rounded-2xl border border-surface2 bg-surface2/70 px-4 py-3 text-sm text-textDim">
          <div class="font-medium text-text">31 урок</div>
          <div class="mt-1">13 модулей • аудио-упражнения</div>
        </div>
      </div>
    ...
    <div class="mt-8 rounded-2xl border border-surface2 bg-surface p-6 shadow-soft">
